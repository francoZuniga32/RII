...
\recuadro{Las reglas se almacenan en una lista en memoria y se aplican en el orden en que están almacenadas. La primera regla cuya cláusula \texttt{from} coincide con el origen del tráfico decide la tabla que se aplicará. 
