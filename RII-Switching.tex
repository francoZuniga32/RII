...
\item ¿Qué información aporta el comando ethtool? ¿Qué clases de placas de red soporta? ¿Qué significa \quotes{Link detected} en la salida de este comando?
...
\figura{broadcast}{Colisiones y broadcasts}{broadcast.jpg}
\end{enumerate}
...
\figura[12]{arbol}{Jerarquía de switches}{arbol.jpg}
...
\figura{dominios}{Dominios}{dominios.jpg}
